...
import br.com.mateuslgomes.dtos.DespensaDto;
...
public class DespesasController {
    ...
    @RequestMapping
    public ResponseEntity<List<Despensas>> despensas(@RequestParam(required = false, value = "descricao") String descricao){
        if (descricao == null) {
            return ResponseEntity.ok(despensasRepository.findAll());
        }
        return ResponseEntity.ok(despensasRepository.findByDescricao(descricao));
    }
